...
impl SwingBuffer{
    ...
    fn slider(&mut self, current_candle: Candle){
...
impl SwingDetector{
    fn new( rolling_window: usize, global_lookback: usize, major_threshold: f64, intermediate_threshold: f64,  current_candle: Candle) -> Self {
        Self {
